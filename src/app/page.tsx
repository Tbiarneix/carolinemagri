        ...
        <div className={styles.hero__content}>
          <div className={styles.hero__presentation}>
            ...
            <div>
              <h2>Bienvenue</h2>
              <p>
                Je m&apos;appelle Caroline MAGRI, je suis psychologue du développement de
                l&apos;enfant et de l&apos;adolescent et sophrologue. Je vous souhaite la bienvenue
                sur mon site, qui a pour objectif de vous éclairer sur ma pratique dans
                l&apos;accompagnement psychologique-enfants, d&apos;adolescents et d&apos;adultes en
                difficulté, à un moment de leur vie.
              </p>
              <p>
                Vous trouverez également sur ce site quelques informations complémentaires, par
                exemple sur les différentes professions «&nbsp;psy&nbsp;» ou encore des informations
                sur la prise en charge en sophrologie.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.professional__content}>
          <div className={styles.professional__column}>
            ...
            <p>
              ...
              tiens compte des contextes au sein desquels elle évolue afin de soutenir
              l&apos;émergence de ses capacités, de favoriser son autonomie et son mieux-être.
          ...
          <div className={styles.professional__column}>
            ...
            <p>
              ...
              adultes, ainsi que des couples et des familles rencontrant des difficultés à un moment
              de leur vie.
            </p>
            <p>
              En fonction de vos difficultés et de votre demande, je pourrais vous proposer un suivi
              psychologique individuel, familial et/ou un bilan psychologique (enfants et
