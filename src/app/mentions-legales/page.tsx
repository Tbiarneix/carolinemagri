...
export default function MentionsLegalesPage() {
  return (
    <div className={shared.pageContainer}>
      ...
      <section>
        <p>
          Conformément aux dispositions de la loi 2004-575 pour la confiance dans l&apos;économie
          numérique, il est porté à la connaissance des utilisateurs du site carolinemagri.fr les
      ...
      <section>
        <h2>Hébergement</h2>
        <p>
          Le site « carolinemagri.fr » est hébergé chez{" "}
      ...
      <section>
        ...
        <p>
          Les présentes Mentions Légales sont régies par la loi française. En cas de différend et à
